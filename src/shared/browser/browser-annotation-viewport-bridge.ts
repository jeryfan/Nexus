...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__nexus_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__nexusBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-nexus-browser-annotation-overlay';
  const markerSize = 24;
