export type LocalWindowsRuntimePreference =
  { kind: 'inherit-global' } | { kind: 'windows-host' } | { kind: 'wsl'; distro: string }

export type GlobalWindowsRuntimeDefault =
  { kind: 'windows-host' } | { kind: 'wsl'; distro: string | null }

export type ProjectExecutionRuntimeReason =
  'project-override' | 'global-default' | 'migration-fallback' | 'non-windows'
...
export type ProjectExecutionRuntimeRepairReason =
  'wsl-unavailable' | 'wsl-distro-required' | 'wsl-distro-missing'
...
export type LegacyWindowsRuntimeFallbackReason =
  'legacy-wsl-unavailable' | 'legacy-wsl-distro-missing'
