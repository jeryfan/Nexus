...
export type BrowserGrabRejectReason =
  'not-ready' | 'not-authorized' | 'already-active' | 'injection-failed'
...
export type BrowserCaptureSelectionScreenshotResult =
  { ok: true; screenshot: BrowserGrabScreenshot } | { ok: false; reason: string }
...
export type BrowserExtractHoverResult =
  { ok: true; payload: BrowserGrabPayload } | { ok: false; reason: string }
