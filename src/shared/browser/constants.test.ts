...
describe('getDefaultSettings', () => {
  it('uses platform-consistent separators for the default workspace directory', () => {
    expect(getDefaultSettings('/Users/alice').workspaceDir).toBe('/Users/alice/nexus/workspaces')
  ...
  it('enables Source Control AI by default without pinning a separate agent', () => {
    ...
    // 裁剪: the sourceControlAi default assertion was removed —
    // getDefaultSettings no longer sets sourceControlAi (unmigrated
    // source-control-ai domain); see the TRIMMED note in ./constants.ts.
  })
