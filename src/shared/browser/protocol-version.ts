// 裁剪: REMOTE_SERVER_UPDATE_CAPABILITY (import, re-export, and
// RUNTIME_CAPABILITIES entry) removed — remote-server-update belongs to the
// unmigrated remote/relay domain.

// Why: declares the Nexus runtime RPC compatibility contract. Desktop,
...
export const FILE_MUTATION_OWNERSHIP_UPDATE_REQUIRED_MESSAGE =
  'Remote file changes require a newer Nexus server. Update the HUB and try again.'
