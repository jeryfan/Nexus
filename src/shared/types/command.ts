...
export type ContextReader =
  ReadonlyMap<string, ContextValue> | Record<string, ContextValue> | ((key: string) => ContextValue)
...
export type NativePopupMenuResult<TCommand extends string = string> =
  { type: 'command'; command: TCommand } | { type: 'custom'; id: string }
