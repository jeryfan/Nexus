...
import type { NexusDataPartTypes } from './uiParts'
...
/** Nexus-specific UIMessagePart with our custom DataUIPart types baked in. */
export type NexusMessagePart = UIMessagePart<NexusDataPartTypes, UITools>
 ...
 * parts the AI SDK produces. Readers can narrow to `NexusMessagePart[]` when
 * they need Nexus-specific data part type safety.
 */
export interface MessageData {
  parts?: NexusMessagePart[]
}

// ── Nexus-specific UI message types ────────────────────────────────

/**
 * Metadata carried on a streamed `NexusUIMessage`.
 *
 ...
 */
export interface NexusUIMessageMetadata {
...
/** Nexus's UIMessage with custom metadata and data part types. */
export type NexusUIMessage = UIMessage<NexusUIMessageMetadata, NexusDataPartTypes>

/** Nexus's UIMessageChunk — inferred from NexusUIMessage. */
export type NexusUIMessageChunk = InferUIMessageChunk<NexusUIMessage>
...
export type CitationReference =
  WebCitationReference | KnowledgeCitationReference | MemoryCitationReference
...
export const TOPIC_MESSAGE_SEARCH_ROLES = [
  'user',
  'assistant'
