...
// endpoints actually configured (e.g. a minimal relay only sets `openai-chat-completions`
// and `anthropic-messages`, not the full EndpointType set).
const ProviderEndpointConfigsSchema = z.partialRecord(
  EndpointTypeSchema,
  EndpointConfigSchema
) as z.ZodType<Partial<Record<EndpointType, EndpointConfig>>>
