// 裁剪:
// - GLOBAL_FLAGS 删除 pairing-code / environment（远程配对域，未迁移）。
// - BOOLEAN_FLAGS / REPEATABLE_STRING_FLAGS / supportsBrowserPageFlag /
//   isCommandGroup 删除非 browser 命令域的条目（account/automations/project/repo/
//   worktree/terminal/file/orchestration/computer/emulator/linear/skills/vm/
//   environment/diagnostics/agent-hooks 等），仅保留 browser 命令面可达的项。
...
export const BOOLEAN_FLAGS = new Set(['focus', 'help', 'json', 'mobile', 'show-profile'])
