...
export function ProviderSettingsContainer({
  ...
  return (
    <Scrollbar
      className={cn(
        'flex min-w-0 flex-1 flex-col [scrollbar-width:none] [&::-webkit-scrollbar]:hidden',
        className
      )}
    >
      {children}
...
export function ProviderSettingsSubtitle({
  children,
  className
}: {
  children: ReactNode
  ...
  return (
    <div
      className={cn(
        'mt-4 select-none font-semibold text-foreground',
        providerSettingsTypography.subtitle,
        className
      )}
    >
      {children}
...
export function ProviderHelpText({
  ...
  return (
    <div className={cn('text-foreground opacity-40', providerSettingsTypography.label, className)}>
      {children}
    </div>
  )
}

export function ProviderHelpTextRow({
  children,
  className
}: {
  children: ReactNode
...
export function ProviderHelpLink({
  ...
  return (
    <a
      className={cn(
        'mx-[5px] cursor-pointer text-primary',
