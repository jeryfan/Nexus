...
const providerSettingsInputGroupBase =
  'h-8 rounded-lg border border-border-muted bg-muted/30 px-2.5 shadow-none'

/** Softer focus ring than `@nexus/ui` InputGroup default (`ring-[3px]`) — business-layer override only. */
...
export const actionClasses = {
  ...
  btnNeutral:
    'border-border-muted bg-transparent text-foreground/70 hover:bg-accent hover:text-foreground'
} as const
...
export const providerListClasses = {
  ...
  searchWrap:
    'flex h-8 items-center gap-1 rounded-[10px] border border-border-muted bg-background py-1 pl-2.5 pr-1',
  ...
  emptyState:
    'flex h-full min-h-40 items-center justify-center px-3 text-center text-foreground-muted text-[14px]',
  addWrap: 'shrink-0',
...
export const drawerClasses = {
  ...
  section: 'space-y-3',
  sectionCard:
    'space-y-3.5 rounded-lg border border-border bg-background px-3 py-3 text-foreground shadow-none',
  ...
  selectContent:
    'rounded-lg border-[0.5px] border-border bg-popover text-popover-foreground shadow-lg',
...
export const modelListClasses = {
  ...
  titleHelpRow:
    'ml-1 flex min-w-0 flex-wrap items-center gap-x-1.5 self-center text-foreground-muted',
  ...
  groupCard:
    'group/modelGroup min-w-0 w-full overflow-hidden rounded-lg border border-border-subtle bg-transparent',
  ...
  groupHeaderIconTooltipTrigger:
    'inline-flex h-6 shrink-0 items-center justify-center leading-none',
...
export const modelSyncClasses = {
  ...
  fetchRowIdStrike:
    'truncate text-sm leading-tight text-foreground-muted line-through decoration-foreground-muted',
  ...
  manageSearchIcon:
    'pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground/60',
...
export const oauthCardClasses = {
  ...
  /** External portal link — matches scoped caption + primary link treatment. */
  externalLink: 'mt-1 inline-block text-xs leading-tight text-primary',
  /** Logged-in account section — one row, no stat grid. */
  shellLoggedIn:
    'w-full min-w-0 overflow-hidden rounded-xl border border-border-subtle px-3 py-2.5',
  ...
  /** Avatar: 32px round avatar, primary fill, initials. */
  avatarSm:
  ...
  badge:
    'inline-flex items-center rounded bg-warning/10 px-1 py-[0.5px] text-[10px] leading-tight text-warning',
  ...
  /** Top-up CTA — solid primary background, white label (compact inline size). */
  ...
  serviceAttribution:
    'mt-2.5 border-t border-border-subtle pt-2.5 text-xs text-muted-foreground/25',
