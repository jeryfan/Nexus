...
const ComposerTriggerPopoverImpl: FC<ComposerTriggerPopoverProps> = ({
  ...
  return (
    <ComposerPrimitive.Unstable_TriggerPopover
      ...
      className={cn(
        'aui-composer-trigger-popover bg-popover text-popover-foreground absolute start-0 bottom-full z-50 mb-2 w-full overflow-hidden rounded-xl border shadow-lg',
        className
      )}
      {...props}
    >
