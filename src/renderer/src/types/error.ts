...
export const isSerializedAiSdkApiCallError = (
  error: SerializedError
): error is SerializedAiSdkApiCallError => {
  return (
...
export const isSerializedAiSdkDownloadError = (
  error: SerializedError
): error is SerializedAiSdkDownloadError => {
  return (
    isSerializedAiSdkError(error) &&
    'url' in error &&
    'statusCode' in error &&
...
export const isSerializedAiSdkInvalidArgumentError = (
  ...
  return (
    isSerializedAiSdkError(error) && 'message' in error && error.name === 'AI_InvalidArgumentError'
  )
}
...
export const isSerializedAiSdkJSONParseError = (
  error: SerializedError
): error is SerializedAiSdkJSONParseError => {
...
export const isSerializedAiSdkNoSuchModelError = (
  error: SerializedError
): error is SerializedAiSdkNoSuchModelError => {
...
export const isSerializedAiSdkNoSuchToolError = (
  error: SerializedError
): error is SerializedAiSdkNoSuchToolError => {
...
export const isSerializedAiSdkRetryError = (
  error: SerializedError
): error is SerializedAiSdkRetryError => {
  return (
    isSerializedAiSdkError(error) && 'reason' in error && 'lastError' in error && 'errors' in error
  )
}
...
export const isSerializedAiSdkErrorUnion = (
  error: SerializedError
): error is SerializedAiSdkErrorUnion => {
  return (
