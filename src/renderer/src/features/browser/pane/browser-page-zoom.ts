...
} from '@shared/browser/browser-page-zoom'
...
export const NEXUS_BROWSER_PAGE_ZOOM_EVENT = 'nexus:browser-page-zoom'
...
export function addBrowserPageZoomEventListener(
  ...
  window.addEventListener(NEXUS_BROWSER_PAGE_ZOOM_EVENT, listener)
  return () => window.removeEventListener(NEXUS_BROWSER_PAGE_ZOOM_EVENT, listener)
}
