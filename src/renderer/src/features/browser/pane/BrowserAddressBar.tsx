...
import { DEFAULT_SEARCH_ENGINE, type SearchEngine } from '@shared/browser/browser-url'
...
export default function BrowserAddressBar({
  ...
  const browserUrlHistory = useBrowserStore((s) => s.browserUrlHistory)
  const browserDefaultSearchEngine = useBrowserStore((s) => s.browserDefaultSearchEngine)
  const browserKagiSessionLink = useBrowserStore((s) => s.browserKagiSessionLink)
      ...
      >
        <PopoverTrigger asChild>
          <form
            ...
            data-nexus-browser-address-bar-overlay={overlay ? 'true' : undefined}
            className={cn(
          ...
          >
            ...
            <Input
              ...
              data-nexus-browser-address-bar="true"
