...
export function ensureBrowserPageWebview({
  ...
  webview.setAttribute('webpreferences', NEXUS_BROWSER_GUEST_WEB_PREFERENCES_ATTRIBUTE)
  ...
  // normal browser behavior instead of leaking app chrome through the guest.
