...
// Why: Monaco here is a viewer, not a type checker — users edit real code in
// their own IDE. The sandboxed TS worker cannot resolve imports to project
// files, so semantic validation produces a long tail of false positives
// (unresolved modules 2307/2792, unused-import fades 6133/6138/6192/6196/6198/
// 6205, missing names 2304/2305, bogus type mismatches 2322/2339/2345/2571/
// 2724, implicit-any 7006/7016/7026/7031/7053/18046/18048). Disable all three
// categories — we keep tokenization (colorization) which is what actually
// gives useful reading affordance here.
