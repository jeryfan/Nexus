...
export const getRawModelId = (model: Model): string =>
  model.apiModelId ?? parseUniqueModelId(model.id).modelId
...
export const isSupportFlexServiceTierModel = (model: Model): boolean =>
  sharedIsSupportFlexServiceTierModel(model)
...
export const isAnthropicModel = (model?: Model): boolean =>
  model ? sharedIsAnthropicModel(model) : false

export const isDeepSeekModel = (model?: Model): boolean =>
  model ? sharedIsDeepSeekModel(model) : false
...
export const isMaxTemperatureOneModel = (model: Model): boolean =>
  sharedIsMaxTemperatureOneModel(model)

// ── Collections ─────────────────────────────────────────────────────────
export const isVisionModels = (models: Model[]): boolean => models.every(isVisionModel)

export const isGenerateImageModels = (models: Model[]): boolean =>
  models.every(isGenerateImageModel)
