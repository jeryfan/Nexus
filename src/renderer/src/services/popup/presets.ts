 ...
 */
const confirm = (props: ConfirmPopupProps): Promise<boolean> =>
  popupService.showConfirm('confirm', props)

const error = (props: ConfirmPopupProps): Promise<boolean> =>
  popupService.showConfirm('error', props)

const info = (props: ConfirmPopupProps): Promise<boolean> => popupService.showConfirm('info', props)

const warning = (props: ConfirmPopupProps): Promise<boolean> =>
  popupService.showConfirm('warning', props)
