/* eslint-disable max-lines -- Why: this file is a command adapter for one external surface, Agent Browser automation. It stays separate from NexusRuntimeService so runtime state does not grow further while browser routing remains easy to scan in one place. */
...
import type { BrowserCertificateProceedResult } from '../../shared/browser/types'
