// 裁剪:
// - computer-use 域（computerUseErrorRecoveryData / COMPUTER_ERROR_CODES 透传分支、computerErrorData 导出）
// - linear 域（LINEAR_ERROR_CODES 透传分支、LINEAGE_ 前缀分支）
// - agent-session-host-authority 域（AGENT_SESSION_RPC_ERROR_CODES 并入 RUNTIME_PASSTHROUGH_CODES）
...
// Why: the NexusRuntimeService throws plain Error objects whose `message` is
