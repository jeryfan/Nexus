...
type BrowserClickedLinkRoutingGlobal = typeof globalThis & {
  __nexusBrowserClickedLinkRouting?: BrowserClickedLinkRoutingState
}
...
export function installBrowserClickedLinkRouting(
  ...
  const existing = routingGlobal.__nexusBrowserClickedLinkRouting
  if (existing) {
  ...
  state.listener = (event) => {
    ...
    // opener-dependent window flows in the guarded popup window.
  ...
  routingGlobal.__nexusBrowserClickedLinkRouting = state
