...
/**
 * Hosts a guest-opened popup inside a window whose top strip is a
 * separate, app-controlled WebContentsView showing the popup's current
...
export function openPopupWithOriginBar(
  ...
  // Why: the origin bar renders only the app's own data: URL and must stay
