...
const enabledByDefaultToggleSupport: ReasoningSupport = {
...
const thinkingWire: ReasoningWireProfile = modeWire('chat_template_kwargs.thinking', {
  off: false,
  auto: true
})
...
const effortWithOffWire: ReasoningWireProfile = modeWire('reasoning_effort', {
  off: 'none',
  effort: EFFORT
})
