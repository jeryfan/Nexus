/**
 * Provider registry — the hand-maintained source for BOTH `resources/provider/providers.json` (HOW to connect:
 * baseUrl / adapterFamily per endpoint, website, apiFeatures) and `resources/provider/provider-models.json` (WHICH
 ...
 * `defaultChatEndpoint` is optional (dynamic providers like ollama/new-api omit it).
 */
