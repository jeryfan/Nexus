...
export const REASONING_FAMILY_RULES: readonly ReasoningFamilyRule[] = [
	...
	{
		pattern: "qwen3-235b-a22b-thinking-2507$",
		budget: { min: 0, max: 81920 },
		template: true,
	},
	{
	...
	{
		pattern: "qwen3-vl-235b-a22b-thinking$",
		budget: { min: 0, max: 81920 },
		template: true,
	},
	{
		pattern: "qwen3-vl-30b-a3b-thinking$",
		budget: { min: 0, max: 81920 },
		template: true,
	},
	{
		pattern: "qwen-plus-2025-07-14$",
		budget: { min: 0, max: 38912 },
		template: true,
	},
	{
		pattern: "qwen-plus-2025-04-28$",
		budget: { min: 0, max: 38912 },
		template: true,
	},
	...
	{
		pattern:
			"^(?!.*(?:coder|asr|tts|reranker|embedding|instruct|thinking))qwen-?3[.-][5-9](?!\\d)",
	},
	{
		pattern:
	...
	{
		pattern:
			"^(?!.*(?:coder|asr|tts|reranker|embedding|instruct|thinking))qwen-?3-\\d",
	},
	...
	{
		pattern:
			"(?:anthropic\\.)?claude-(:?sonnet|haiku)-4[.-]6.*(?:-v\\d+:\\d+)?$",
	...
	{
		pattern:
			"doubao-seed-1-6-(?:lite-)?251015|doubao-seed-2[.-]\\d|doubao-seed-1[.-]8",
		effort: ["minimal", "low", "medium", "high"],
	},
	{
		pattern:
			"doubao-(1-5-thinking-pro-m|seed-1[.-]6)(?!-(?:flash|thinking)(?:-|$))(?:-lite)?(?!-251015)(?:-\\d+)?$",
	...
	{
		pattern:
			"^gemini-3(?:\\.\\d+)?-flash|^gemini-3\\.1-flash-lite|^gemini-flash-latest",
		effort: ["minimal", "low", "medium", "high"],
	},
	{ pattern: "^gemini-3-pro", effort: ["low", "high"] },
	{
		pattern: "^gemini-3\\.\\d+-pro|^gemini-pro-latest",
	...
	{
		pattern: "gemma-?4[:-]?e[24]b",
		budget: { min: 1024, max: 8192 },
		template: true,
	},
	{
		pattern: "gemma-?4[:-]?26b",
		budget: { min: 1024, max: 30720 },
		template: true,
	},
	{
		pattern: "gemma-?4[:-]?31b",
	...
	// nvidia
	{ pattern: "nemotron-(?:nano|super|ultra|3-(?:nano|super|ultra))" },
	// openai
	...
	// perplexity
	{
		pattern: "^sonar-reasoning|^sonar-deep-research",
		effort: ["low", "medium", "high"],
	},
	...
	// xai
	{
		pattern: "^grok-4\\.3(?!.*non-reasoning)",
		effort: ["none", "low", "medium", "high"],
	},
	...
	// xiaomi
	{
		pattern: "mimo-v2[.-]5(?:-pro)?(?!-)|mimo-v2-(?:flash|pro|omni)",
		toggle: true,
	},
