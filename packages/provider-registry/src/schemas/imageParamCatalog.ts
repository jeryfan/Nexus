...
export type ParamValue<K extends CanonicalParamKey> = z.infer<
  (typeof IMAGE_PARAM_CATALOG)[K]['schema']
>
...
export const imageParamsSchema = z.object(
  Object.fromEntries(
    Object.entries(IMAGE_PARAM_CATALOG).map(([key, entry]) => [key, entry.schema])
  ) as {
