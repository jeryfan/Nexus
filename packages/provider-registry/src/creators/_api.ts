...
/** Resolve a connection host: a full `https://…` base, or a Nexus provider id → its baseUrl. */
...
/** OpenAI-compatible `GET {base}/models`. `providerOrUrl` = a Nexus provider id or a full base. */
