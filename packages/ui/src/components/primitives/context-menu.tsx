...
const ContextMenuOpeningPointerUpGuardContext =
  React.createContext<ContextMenuOpeningPointerUpGuard | null>(null)
...
function stopOpeningPointerUp(
  event: React.PointerEvent,
  pointerUpGuard: ContextMenuOpeningPointerUpGuard | null
) {
