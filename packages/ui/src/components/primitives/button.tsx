  ...
  ),
  {
    variants: {
      variant: {
        ...
        secondary:
          'rounded-lg bg-secondary text-secondary-foreground shadow-none hover:bg-secondary-hover',
        ...
        ghost:
          'text-neutral-900 shadow-none hover:bg-accent hover:text-accent-foreground dark:text-neutral-100',
