...
const GeminiCli: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  const iconId = useId()
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath={`url(#${iconId}-geminicli__a)`}>
        <path
          fill={`url(#${iconId}-geminicli__b)`}
      ...
      <defs>
        ...
        <clipPath id={`${iconId}-geminicli__a`}>
