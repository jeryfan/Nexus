...
const ModelscopeLight: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path fill="#624AFF" d="M85.5544 56.7835H93.0001V64.1737H85.5544V56.7835Z" />
    <path fill="#36CFD1" d="M85.5544 49.3935H93.0001V56.7835H85.5544V49.3935Z" />
    <path fill="#624AFF" d="M71.6697 43V49.3932H79.1149V56.7833H85.5561V43H71.6697Z" />
    <path fill="#36CFD1" d="M49.334 56.7835H56.7792V64.1737H49.334V56.7835Z" />
    <path
      fill="#624AFF"
...
export { ModelscopeLight }
export default ModelscopeLight
