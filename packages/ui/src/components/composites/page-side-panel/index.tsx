...
import { usePortalContainer } from '@nexus/ui/components/primitives/portal-container'
...
function PageSidePanel({
  ...
  const portalContainer =
    scopedContainer ?? (typeof document === 'undefined' ? null : document.body)
          ...
          >
            {hasHeader && (
              <div
                ...
                className={cn(
                  'flex shrink-0 items-center justify-between px-6 pt-6 pb-3',
                  headerClassName
                )}
              >
                <div
                  id={headerContent ? headerId : undefined}
...
function PageSidePanelSection({
  title,
  actions,
  children,
  className,
  ...props
}: PageSidePanelSectionProps) {
  return (
